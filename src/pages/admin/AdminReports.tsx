...
export default function AdminReports({ onNavigate: _onNavigate }: AdminReportsProps) {
  ...
  @page { 
    size: A4; 
    margin: 5mm; /* මාජින් එක අඩු කළා එවිට පේජ් එකේ ඉඩ වැඩි වෙනවා */
  }
  ...
  .print-section { 
    ...
    top: 0; 
    width: 100%; 
    padding: 0 !important; /* අනවශ්‍ය Padding අයින් කළා */
    margin: 0 !important; /* අනවශ්‍ය Margin අයින් කළා */
    color: #000 !important; 
    background: white !important;
  }
  .no-print { display: none !important; }
  
  /* PDF එකේ කොටස් අතර හිස් ඉඩ අඩු කිරීමට */
  .grid { 
  ...
  .rv-panel { 
    ...
    padding: 8px !important; /* Panel එක ඇතුළේ ඉඩ අඩු කළා */
  }
  
  /* අකුරු වල වර්ණ කළු කිරීම (Print එක පැහැදිලි වීමට) */
  .text-[#F4F6FF] { color: #000 !important; }
  .text-[#A7ACB8] { color: #333 !important; }
  .bg-\\[rgba\\(79\\,70\\,229\\,0\\.15\\)\\] { background: #f0f0f0 !important; }
  .border-white\\/5 { border-color: #ddd !important; }

  /* Table එකේ හිස් ඉඩ අඩු කිරීම */
  table { width: 100% !important; margin-top: 2mm !important; }
        ...
        <div className="hidden print:block mb-8 border-b-2 border-black pb-6">
          <div className="flex justify-between items-center">
             <div>
                ...
                />
                <h1 className="text-2xl font-bold tracking-tight">RV DEVELOPERS</h1>
